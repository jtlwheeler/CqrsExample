...
namespace Banking.Tests.CommandProcessor.Events
{
    public class EventConvertTests
    {
        ...
        public void WhenEventIsABankAccountCreatedEvent_ThenJsonIsDeserializedSuccessfully()
        {
            var jsonEvent = "{"
                ...
                + "\"AggregateRootId\": \"11111111-1111-1111-1111-111111111111\","
            ...
            bankAccountCreatedEvent.AggregateRootId.Should().Be(Guid.Parse("11111111-1111-1111-1111-111111111111"));
